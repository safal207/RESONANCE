...
- Evidence: bounded fixture `PASS` at frozen source subject `6e51cbb176f6d891b758e3026744d1d4c4c5727a`, verified by current PR #61 runtime subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`, based on exact main `b54173530c675083426137176cde0aed0b90853a`; workflow run #20 (`31879737027`) completed successfully, with artifact digest `sha256:9eb7e5f6d5e60cf0e65eb92f1d90408bcb91960e2118bceee0e33181fe274474`.
...
- Machine evidence: P0-4 workflow run #17 (`31879737033`) passed at current verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; all five checks (`initial_subject`, `final_subject`, `ancestry`, `workflow_identity`, `artifact_subject`) were `PASS`, with unknown policy `unknown_never_becomes_pass`. Artifact digest: `sha256:01786122fd21323126e94a7f995769f4f80caabdadcdff5ac781822d1deac023`.
- Rebound SYSTEM-007 evidence: full-chain run #19 (`31879737027`) passed at current verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329` with 17/17 substantive steps and artifact digest `sha256:9eb7e5f6d5e60cf0e65eb92f1d90408bcb91960e2118bceee0e33181fe274474`.
...
- Machine evidence: workflow run #16 (`31879736993`) passed at current verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; 16/16 cases were replay-stable and evidence-complete, with 15 `BLOCK` negative cases, one `ACCEPT` policy-eligible dry-run control, and zero executed cases. Artifact digest: `sha256:1e8197444292f3a7adb16f7f404f56cef3dbf64b024a9754bc8f1e2ea04dc4bf`.
...
- Machine evidence: workflow run #15 (`31879737106`) passed at runtime verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; the bundle contains four exact component subjects, six artifacts, six replay steps and 1,410 bytes. Replay is `SAME_RESULT`, membership and SHA-256 checks pass, and all authority flags remain `false`. Artifact digest: `sha256:aac513ed32394e819eefbf5b2b61d1067cfe58a56583f98992600b9bea1f619b`.
...
- Machine evidence: workflow run #14 (`31879737024`) passed at runtime verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`, based on exact PR #61 base `b54173530c675083426137176cde0aed0b90853a`; five source subjects, three artifacts, 1,254 bytes, four cases, replay `SAME_RESULT`, three `BLOCK`, one `HOLD`, and zero executed cases. Artifact digest: `sha256:4e0b816d95817795b08297f02f2cc0c2b13ea2dc01eec74dd2df0778c9f49a4e`.
...
- Identity rule: runtime verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329` and frozen ContractGraph-QA fixture source subject `6e51cbb176f6d891b758e3026744d1d4c4c5727a` are recorded separately; a source subject is cargo provenance, not the verifier checkout identity.
...
- Machine evidence: occurrence portability [run #4](https://github.com/safal207/ContractGraph-QA/actions/runs/31879737013) passed at verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; artifact `fcrp-p1-4-6-occurrence-portability-31879737013-1`, digest `sha256:9cf005d73a07f4f356581337c27c378747b199ada278bd9122f8f3db71559200`, artifact size 1,803 bytes.
...
- Machine evidence: [workflow run #3](https://github.com/safal207/ContractGraph-QA/actions/runs/31879737094) passed at verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; all 11 steps completed successfully; artifact `fcrp-p1-7-independent-cross-repo-replay-31879737094-1`, 2,496 bytes, digest `sha256:cb4d3eec62eee29787dd6608faa9dde804270c6afe450aa4a2560d90bb665528`.
...
- Machine evidence: [workflow run #2](https://github.com/safal207/ContractGraph-QA/actions/runs/31879737060) passed at current verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; all 11 steps completed successfully; artifact `fcrp-p1-8-compatibility-migration-31879737060-1`, 3,314 bytes, digest `sha256:dc6ca4d597b0fee05528e20bf6f9a72d6d2e6a2e67931eab8c2c8d2d5ddaf28e`.
...
- Compatibility receipt: nine exact subject records, subject fingerprint `7ab24d3ad5fea76d550945161119defedad9439d381c984d27468015064f5902`, receipt digest `sha256:1ff96a229c5c99ed06d29dba0be7c3097e86d449e19fffd66a0e49becb9deb61`, witness digest `0e617714b4f02e4dcfe8afe08e89c0d0d3e4e4f8ec3c65662243b0b09e1fabff`; source mutation, execution, external effects and production ledger mutation remain `false`.
...
- Machine evidence: ContractGraph-QA P2-4 [workflow run #1](https://github.com/safal207/ContractGraph-QA/actions/runs/31879737058) passed at verifier subject `7fd3e744037832b74b2ee4c4c71cc8fce18fc329`; 11/11 substantive steps succeeded. Artifact `fcrp-p2-4-maintenance-routine-31879737058-1`, 2,397 bytes, digest `sha256:d63a58cca47d7fcc329963b8c1438af9316927d0b6f9bd56982799bbcec9c0b3`. The independent receipt reports policy `QUALITY_ONLY_NO_MERGE_AUTHORITY`, two routines, 2/2 evidence-complete, 2/2 independently verified, 2/2 replay-stable, 2/2 outcome-attributed and all authority flags `false`; receipt digest `sha256:50e4c0ebdf7428142e9951adbae983673ff76c76e8fce97f78cd8ee5087c254e`, witness digest `72df07094cce9975a9ffb631a65fe70561c30c3fa8b884b7f1a5afc07bf69b0c`.
...
- Scope boundary: the bounded contract/evaluator is verified; the broader autonomous maintenance service, auto-merge policy and production routine remain unimplemented and unauthorized.
- Next transition: P2-1 measure cost and latency of the trust spine.
