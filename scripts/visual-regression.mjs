...
const routes = [
  ...
  { id: 'article015-en', route: 'when-order-book-depth-changes.html' },
  { id: 'article015-ru', route: 'when-order-book-depth-changes.ru.html' },
  { id: 'article015-zh', route: 'when-order-book-depth-changes.zh.html' },
