...
5. [`Article 09 — Cancellation Is a State Transition`](../issues/001-age-of-agents/articles/09-cancellation-is-a-state-transition.md)
6. [`Article 10 — Consent Has a Causal Lifetime`](../issues/001-age-of-agents/articles/10-consent-has-a-causal-lifetime.md)
7. [`Article 11 — Evidence Has a Route`](../issues/001-age-of-agents/articles/11-evidence-has-a-route.md)
8. [`Article 12 — A Diagnostic Nobody Can See Is Not a Signal`](../issues/001-age-of-agents/articles/12-a-diagnostic-nobody-can-see-is-not-a-signal.md)
9. [`Article 13 — Evidence Must Bind the Transition`](../issues/001-age-of-agents/articles/13-evidence-must-bind-the-transition.md) · [web edition](https://safal207.github.io/RESONANCE/evidence-must-bind-the-transition.ru.html)
10. [`Signal 011 — Genesis / Historical Trust-Base Portability`](011-genesis-historical-trust-base-portability.md)
11. [`Signal 012 — Downstream Causal-State Portability`](012-downstream-causal-state-portability.md)
12. [`Signal 013 — Recursive Verification Skill Mesh / Journal-Driven Agent Routing`](013-recursive-verification-skill-mesh.md)
13. [`Signal 014 — Persistence Frontier / Native Consumer Acceptance Is Not Durable State`](014-persistence-frontier-native-consumer-acceptance.md)
14. [`Signal 015 — Durability Frontier / Commit ≠ Ack ≠ Retry Permission`](015-durability-frontier-commit-ack-retry.md)
15. [`Signal 016 — Meaning May Change / Trace Must Not`](016-meaning-may-change-trace-must-not.md)
16. [`Signal 017 — Authority Causality / Current Owner Gate`](017-authority-causality-current-owner-gate.md)
